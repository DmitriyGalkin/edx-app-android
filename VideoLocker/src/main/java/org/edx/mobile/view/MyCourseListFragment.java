...
import org.edx.mobile.databinding.FragmentMyCourseListBinding;
...
public class MyCourseListFragment extends BaseFragment implements NetworkObserver, LoaderManager.LoaderCallbacks<AsyncTaskResult<List<EnrolledCoursesResponse>>> {

    private static final int MY_COURSE_LOADER_ID = 0x905000;

    private MyCourseAdapter adapter;
    private FragmentMyCourseListBinding binding;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyCourseAdapter(getActivity(), environment) {
            ...
            public void onItemClicked(EnrolledCoursesResponse model) {
                MyCourseListFragment.this.environment.getRouter().showCourseDashboardTabs(getActivity(), MyCourseListFragment.this.environment.getConfig(), model, false);
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_my_course_list, container, false);
